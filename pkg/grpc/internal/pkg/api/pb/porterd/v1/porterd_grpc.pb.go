...
func (c *porterServiceClient) Install(ctx context.Context, in *IntallRequest, opts ...grpc.CallOption) (PorterService_InstallClient, error) {
	stream, err := c.cc.NewStream(ctx, &PorterService_ServiceDesc.Streams[0], "/porterd.v1.PorterService/Install", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *porterServiceClient) Upgrade(ctx context.Context, in *UpgradeRequest, opts ...grpc.CallOption) (PorterService_UpgradeClient, error) {
	stream, err := c.cc.NewStream(ctx, &PorterService_ServiceDesc.Streams[1], "/porterd.v1.PorterService/Upgrade", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *porterServiceClient) UnInstall(ctx context.Context, in *UnIntallRequest, opts ...grpc.CallOption) (PorterService_UnInstallClient, error) {
	stream, err := c.cc.NewStream(ctx, &PorterService_ServiceDesc.Streams[2], "/porterd.v1.PorterService/UnInstall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *porterServiceClient) Execute(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (PorterService_ExecuteClient, error) {
	stream, err := c.cc.NewStream(ctx, &PorterService_ServiceDesc.Streams[3], "/porterd.v1.PorterService/Execute", opts...)
	if err != nil {
		return nil, err
	}
...
var PorterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "porterd.v1.PorterService",
	...
	Metadata: "porterd/v1/porterd.proto",
}
